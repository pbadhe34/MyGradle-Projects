...
<xsl:param name="TITLE">Unit Test Results in Custom Format.</xsl:param>
...
<html>
    ...
    <frameset cols="20%,80%">
        ...
        <noframes>
            <h2>Frame Alert</h2>
            <p>
                This CUSTOM Frames document is designed to be viewed using the frames feature. If you see this message, you are using a non-frame-capable web client.
            </p>
        </noframes>
    </frameset>
</html>
